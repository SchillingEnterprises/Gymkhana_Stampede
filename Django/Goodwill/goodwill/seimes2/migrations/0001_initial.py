# Generated by Django 2.0.2 on 2018-02-12 01:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_address', models.TextField(verbose_name='address')),
                ('city', models.CharField(max_length=58, verbose_name='city')),
                ('state', localflavor.us.models.USStateField(default='KY', max_length=2, verbose_name='state')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='USD', max_digits=11)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seimes2.Customer')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seimes2.Employee')),
                ('inventory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seimes2.Inventory')),
                ('store_branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seimes2.StoreBranch')),
            ],
        ),
    ]
